...
$routes->group('admin', function($routes){
    $routes->add('user','Admin\Users::user');
    $routes->add('users',"Admin\Users::getallUsers");                       //use forward slash in routes
    $routes->add('shopa/(:any)/(:any)',"Admin\Shop::product/$1/$2");        //use backward slash in (;any) or $1 
